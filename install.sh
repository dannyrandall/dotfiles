...
files="zshrc xinitrc Xdefaults vimrc functions aliases alacritty.yml tmux.conf vim/colors vim/after/ftplugin"    # list of files/folders to symlink in homedir
